...
describe('index.js', () => {
  ...
  test('sends Slack notifications when a rotation is available', async () => {
    ...
    expect(SlackMessage).toHaveBeenCalledWith('eve@example.com', 'You have an upcoming out of hours allocation on Thursday 9th January')
    expect(SlackMessage).toHaveBeenCalledWith('trent@example.com', 'You have an upcoming out of hours allocation on Thursday 9th January')
  })
